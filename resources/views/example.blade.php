...
<html>
    ...
    <body>
        ...
        >
            ...
            >
                <!-- start::Logo -->
                <div class="flex items-center justify-center bg-white dark:bg-panel-dark bg-opacity-30 h-16">
                    ...
                    >
                        ...
                        >
                            <div class="flex items-center">
                                ...
                                <span class="ml-3">Heregistrasi</span>
                            </div>
            ...
            <div class="lg:pl-64 w-full flex flex-col">
                ...
                <!-- start:Page content -->
                <div class="h-full bg-light dark:bg-dark p-8">
                    <!-- start::Stats -->
                    ...
                    <div class="flex flex-col xl:flex-row space-y-4 xl:space-y-0 xl:space-x-4">
                        ...
                        <div class="w-full xl:w-1/3 p-6 space-y-6 bg-white dark:bg-panel-dark dark:text-white rounded-lg shadow-xl capitalize">
